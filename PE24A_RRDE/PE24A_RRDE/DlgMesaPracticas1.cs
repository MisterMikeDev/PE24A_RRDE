...
namespace PE24A_RRDE
{
    ...
    public partial class DlgMesaPracticas1 : Form
    {
        ...
        public DlgMesaPracticas1()
        {
            ...
            /* ------------------------------------------------------------------------- */
            // Crea el intervalo y lo deja en espera para iniciarlo
            /* ------------------------------------------------------------------------- */
            CreateInterval(ReCalculate, 2000);

            /* ------------------------------------------------------------------------- */
            // Colorea el boton del timer dependiendo de su estado
            /* ------------------------------------------------------------------------- */
            ColorBtnTimer();
        }
        ...
        /* ------------------------------------------------------------------------- */
        // Activa la tabla de la practica 2
        /* ------------------------------------------------------------------------- */
        ...
        private void BtnP2Llenar_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < RowCount; i++)
            {
                for (int j = 0; j < ColCount; j++)
                {
                    ...
                    {
                        /* ------------------------------------------------------------------------- */
                        // Esto se hace para que tenga un valor que nunca estará en la tabla
                        /* ------------------------------------------------------------------------- */
                        NextCeilValue = -999999999;
                    }
        ...
        /* ------------------------------------------------------------------------- */
        // Hace un toggle de timer enable
        /* ------------------------------------------------------------------------- */
        private void BtnP2Timer_Click(object sender, EventArgs e)
        {
        ...
        /* ------------------------------------------------------------------------- */
        // Recalcula los valores de la tabla
        /* ------------------------------------------------------------------------- */
        private void ReCalculate()
        {
            if (ErrorTableIsNull()) return;
            ColorBtnTimer();
            BtnP2Llenar_Click(null, null);
            BtnP2Diagonal_Click(null, null);

        }

        /* ------------------------------------------------------------------------- */
        // Establece el color del boton timer
        /* ------------------------------------------------------------------------- */
        private void ColorBtnTimer()
        {
            if (timer == null) return;

            if (timer.Enabled) BtnP2Timer.BackColor = Color.LightGreen;
            else BtnP2Timer.BackColor = Color.Red;
        ...
        /* ------------------------------------------------------------------------- */
        private void CreateInterval(Action action, int timeout)
        {
            /* ------------------------------------------------------------------------- */
            // Intervalo
            /* ------------------------------------------------------------------------- */
        ...
        /* ------------------------------------------------------------------------- */
        // Limpia el intervalo y lo deja en null
        /* ------------------------------------------------------------------------- */
        ...
        /* ------------------------------------------------------------------------- */
        // Comprueba que la tabla exista y retorna un booleano
        /* ------------------------------------------------------------------------- */
        private bool ErrorTableIsNull()
        {
            if (DgvTabla2 == null)
            {
                ClearInterval();
                MessageBox.Show("La tabla no ha sido generada.");
                return true;
            }
